...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Zit de maat niet goed? Geen probleem — we ruilen gratis van maat binnen 30 dagen. Wil je het volledig retourneren? Dat kan ook binnen 30 dagen; de verzendkosten zijn dan voor eigen rekening.",
      },
    },
    {
      "@type": "Question",
