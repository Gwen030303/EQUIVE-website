    ...
    <AnimatePresence>
      {visible && (
        <motion.a
          ...
          className="fixed bottom-[136px] right-6 z-30 flex items-center justify-center w-12 h-12 rounded-full bg-[#25D366] hover:bg-[#20BD5A] shadow-lg transition-colors duration-200"
        >
